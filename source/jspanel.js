...
let jsPanel = {
    ...
    ajax(obj) {
        const conf = obj.options.contentAjax,
            configDefaults = {
                method: 'GET',
                async: true,
                user: '',
    ...
    resizeit(elmt, options = {}) {
        ...
        Array.prototype.slice.call(elmt.getElementsByClassName('jsPanel-resizeit-handle')).forEach((handle) => {
                ...
                handle.addEventListener(item, (e) => {
                    ...
                    resizePanel = (evt) => {
                        ...
                        if (!resizestarted) {
                            ...
                            if (typeof opts.start === 'function') {opts.start.call(elmt, elmt, {width: startWidth, height: startHeight});}
                            jsPanel.front(elmt);
                        }
                        resizestarted = 1;
                        ...
                        if (typeof opts.resize === 'function') {opts.resize.call(elmt, elmt, values);}
                    };
    ...
    create(options = {}, cb) {
        ...
        self.applyArbitraryTheme = (themeDetails) => {
            ...
            self.querySelectorAll('.jsPanel-controlbar .jsPanel-btn .jsglyph').forEach((item) => {
        ...
        self.clearTheme = (callback) => {
            ...
            Array.prototype.slice.call(self.controlbar.querySelectorAll('.jsglyph'))
        ...
        self.close = (callback) => {
            ...
            const doClose = () => {
                ...
                if (opts.onclosed) {opts.onclosed.call(panelId, panelId);}
                ...
                if (opts.minimizeTo === 'default') {
                    ...
                    if (typeof opts.minimizeTo === 'string') {
                        if (opts.minimizeTo === 'parentpanel') {
                            const parent = self.closest('.jsPanel-content').parentNode,
        ...
        self.setIconfont = (font = 'jsglyph', panel = self, callback) => {
            if (font !== 'jsglyph') {
